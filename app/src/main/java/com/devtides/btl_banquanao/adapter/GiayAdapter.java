package com.devtides.btl_banquanao.adapter;
...
import com.devtides.btl_banquanao.Activity.ChiTietActivity;
import com.devtides.btl_banquanao.Interface.ItemClickListener;
...
public class GiayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    List<SanPhamMoi> arraygiay;
    private  static  final int VIEW_TYPE_DATA = 0;
    private  static  final int VIEW_TYPE_LOADING = 1;
    public GiayAdapter(Context context, List<SanPhamMoi> arraygiay) {
        this.context = context;
        this.arraygiay = arraygiay;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof MyViewHolder){
            ...
            SanPhamMoi sanPham = arraygiay.get(position);
    ...
    public int getItemViewType(int position) {
        return arraygiay.get(position) == null ? VIEW_TYPE_LOADING:VIEW_TYPE_DATA;
    }

    @Override
    public int getItemCount() {
        return arraygiay.size();
    }
