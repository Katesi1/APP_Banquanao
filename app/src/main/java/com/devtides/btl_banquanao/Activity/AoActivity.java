...
import com.devtides.btl_banquanao.adapter.AoAdapter;
...
public class AoActivity extends AppCompatActivity {
    ...
    private void getData(int page) {
        compositeDisposable.add(apibanhang.getAo(page,loai)
                        ...
                        sanPhamMoiModel -> {
                            if(sanPhamMoiModel.isSuccess()) {
                                if (adapterao == null) {
                                    ...
                                    adapterao.notifyItemRangeInserted(vtri, soluongadd);
                                }
